...
export function add(a: Decimal | bigint | string | number, b: Decimal | bigint | string | number): Decimal {
...
export function subtract(a: Decimal | bigint | string | number, b: Decimal | bigint | string | number): Decimal {
    const aDec = a instanceof Decimal ? a : new Decimal(a.toString());
    const bDec = b instanceof Decimal ? b : new Decimal(b.toString());
...
export function multiply(a: Decimal | bigint | string | number, b: Decimal | bigint | string | number): Decimal {
    const aDec = a instanceof Decimal ? a : new Decimal(a.toString());
    const bDec = b instanceof Decimal ? b : new Decimal(b.toString());
...
export function divide(a: Decimal | bigint | string | number, b: Decimal | bigint | string | number): Decimal {
    const aDec = a instanceof Decimal ? a : new Decimal(a.toString());
    const bDec = b instanceof Decimal ? b : new Decimal(b.toString());
    if (bDec.isZero()) {
...
export function compare(a: Decimal | bigint | string | number, b: Decimal | bigint | string | number): number {
    const aDec = a instanceof Decimal ? a : new Decimal(a.toString());
    const bDec = b instanceof Decimal ? b : new Decimal(b.toString());
...
export function isZero(amount: Decimal | bigint | string | number): boolean {
    const dec = amount instanceof Decimal ? amount : new Decimal(amount.toString());
    return dec.isZero();
}

// Check if amount is positive

export function isPositive(amount: Decimal | bigint | string | number): boolean {
    const dec = amount instanceof Decimal ? amount : new Decimal(amount.toString());
...
export function isNegative(amount: Decimal | bigint | string | number): boolean {
    const dec = amount instanceof Decimal ? amount : new Decimal(amount.toString());
